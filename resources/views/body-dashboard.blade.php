    ...
    <div class="col-6" style="">
        ...
        @foreach ($posts as $post)
            <div class="row" style="background-color:white;margin-top: 5%;padding:10px;box-shadow: rgba(0, 0, 0, 0.24) 0.5px 1px 1px 0px;border-radius:8px">
                ...
                <!--si le texte et l'image existe-->
                @if (isset($post->text) && isset($post->image))
                    <div class="row">
                        <p>{{$post->text}}</p>
                    </div>
                    <div class="row" id="divpost" style="background-color:none" id="block-post">
                        <!--<p style="color: white;text-align:center;padding-left:60px;padding-top:90px;padding-bottom:65px;font-size:30px"></p>-->
                            <img src="imageposts/{{$post->image}} " alt="" srcset="" style="width: 100%;height:100%">
                        <div class="col-10">
                        </div>
                    </div>
                <!--s'il y'a pas d'image-->
                @elseif($post->image==null)
                    <div class="row" id="divpost" style="background-color:#9b26b6" id="block-post">
                        <p style="color: white;text-align:center;padding-left:10px;padding-top:90px;padding-bottom:65px;font-size:30px">{{$post->text}}</p>
                            <!--<img src="imageposts/{{$post->image}} " alt="" srcset="" style="width: 100%;height:100%">-->
                    </div>
                <!--s'il y'a pas de texte-->
                @elseif($post->text==null)
                    <div class="row" id="divpost" style="background-color:none" id="block-post">
                        <!--<p style="color: white;text-align:center;padding-left:60px;padding-top:90px;padding-bottom:65px;font-size:30px"></p>-->
                            <img src="imageposts/{{$post->image}} " alt="" srcset="" style="width: 100%;height:100%">
                        <div class="col-10">
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        <form action="" method="get">
                                <div class="row" id="buttonComment{{$post->id}}">
                                    <div class="col-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-hand-thumbs-up-fill" viewBox="0 0 16 16">
                ...
                <div class="row" id="divComment{{$post->id}}">
                    <div class="col-md-10">
                        <input type="text" name="coment{{$post->id}}" id="coment{{$post->id}}" placeholder="Votre commentaire" style="width:100%;border-radius:5px">
                    </div>
                    <div class="col-md-2">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row" id="blockImage" style="height: 300px;text-align:center;display:none;">
                                <label for="image">
                                    <img src="images\logo 3.png"  alt="image" class="picture" style="opacity: 0.2;height:300px;width:100%;cursor:pointer;">
                                </label>
                            </div>

                            <input type="file" name="image" id="image" style="display:block;visibility:hidden;">
