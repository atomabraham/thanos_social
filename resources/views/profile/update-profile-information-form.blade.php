<x-form-section submit="updateProfileInformation">
    <x-slot name="title">
        {{ __('Informations personnelle') }}
    </x-slot>

    <x-slot name="description">
        {{ __('Modifier vos informations personnelle') }}
    </x-slot>
    ...
    <x-slot name="form">
        ...
        @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
            <div x-data="{photoName: null, photoPreview: null}" class="col-span-6 sm:col-span-4">
                ...
                <x-label for="photo" value="{{ __('Photo de profile') }}" />
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="secondname" type="text" class="mt-1 block w-full" wire:model.defer="state.secondname" autocomplete="secondname" />
